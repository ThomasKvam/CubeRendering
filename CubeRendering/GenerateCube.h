...
// This is an include guard. It prevents the contents of this file from being included 
// more than once in a single compilation unit (source file). 
// This helps avoid errors due to duplicate declarations.
